...
class Participant(models.Model):
	...
	instn = models.ForeignKey(Institution, blank=True, null=True, related_name='instn')
	...
	company = models.ForeignKey(Institution, blank=True, null=True, related_name='company')
